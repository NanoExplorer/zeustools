...
def flat_to_wm2(sky_transparency,
    ...
    Parameters:
    sky_transparency: The line-of-sight transparency of the sky. 
    ...
    pixel_deltalambda: Astropy Quantity containing the difference in wavelength between light 
        seen by the line pixel and a pixel next to it.
        TODO: how linear is it really?
    sky_temp, cabin_temp, and beam_size should be pretty self-explanatory,
        but they all need to be astropy quantities!
    """
